...
data = dict(
    ...
    train=gen_all_slide("/data/dataset/hand/splited/slide/train/yufenni/2022_12_20/", False),
    val=gen_all_slide("/data/dataset/hand/splited/slide/train/yufenni/2022_12_20/", True),
    test=gen_all_slide("/data/dataset/hand/splited/slide/train/yufenni/2022_12_20/", True),
        )
# optimizer
