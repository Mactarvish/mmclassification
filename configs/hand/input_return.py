...
data = dict(
    ...
    train=gen_all_slide("/data/dataset/hand/backup/slide/website_simulation/2023_01_10/", False),
    ...
    val=gen_sub_data("/data/dataset/hand/backup/slide/website_simulation/2023_01_09/", True),
    test=gen_sub_data("/data/dataset/hand/backup/slide/website_simulation/2023_01_09/", True),
        )
# optimizer
