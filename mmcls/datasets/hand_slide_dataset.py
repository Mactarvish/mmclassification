...
from .utils.parse_frames import parse_raw_files_to_frames, LABELS
...
class HandSlideDataset(BaseDataset):
    def __init__(self,
        ...
        if not test_mode:
            ...
            print(len(sampled_nones))
            self.samples = sampled_nones + down_samples + up_samples
    ...
    def convert_action_to_sample(self, action):
        ...
        result["target"] = action.soft_label
